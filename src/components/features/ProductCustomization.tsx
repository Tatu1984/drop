...
export default function ProductCustomization({ product, isOpen, onClose }: ProductCustomizationProps) {
  ...
  const handleAddToCart = () => {
    ...
    // Convert selections to SelectedCustomization format
    const customizationsData = customizations.map((group) => ({
      customizationId: group.id,
      optionIds: selections[group.id] || [],
    }));

    // Create a modified product with the customization price applied
